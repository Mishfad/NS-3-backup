...
MyApp::SendPacket (void)
{
  ...
  NS_LOG_UNCOND("Packet number: "<<int(m_buffer));
  m_buffer++;
...
//  devices.Get (1)->SetAttribute ("ReceiveErrorModel", PointerValue (em));
  	...
  	pos.Set("X",StringValue("ns3::UniformRandomVariable[Min=0.0|Max=100]"));
  	pos.Set("Y",StringValue("ns3::UniformRandomVariable[Min=0.0|Max=100]"));
